...
# FIX: Bổ sung thêm các thư viện còn thiếu như libgbm-dev, libnss3, và libdrm2
RUN apt-get update && apt-get install -yq \
    ...
    libappindicator1 libnss3 lsb-release xdg-utils wget libgbm-dev libxshmfence1 libdrm2 \
